...
wp_nav_menu( array( //wp_nav_menu args, look at documentation for more options.
    'menu' => 'Presidents Office Menu', 'container' => 'true', 'menu_class' => 'submenu no-bullet' ) ); ?>
</div>


<div>        
<?php do_action( 'foundationpress_before_sidebar' ); ?>        
<h3>Local College Board</h3>    
<?php //get custom sidebar menu for section
wp_nav_menu( array( //wp_nav_menu args, look at documentation for more options.
    'menu' => 'College Board Menu', 'container' => 'true', 'menu_class' => 'submenu no-bullet' ) ); ?>
</div>
