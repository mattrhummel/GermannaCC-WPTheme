...
<!--Quicklinks Container-->
  <div class="quicklinks-container contain-to-grid hidden-for-small show-for-medium-up">
    <div class="quicklinks-bar" data-topbar role="navigation" aria-labelledby="QuicklinksNavigation">
      <div class="row">
        <!--Container For Call To Menu-->
        <div class="small-12 medium-9 large-9 columns" id="QuicklinksNavigation">
  ...
  <div class="banner contain-to-grid show-for-medium-up hidden-for-small-only" itemscope itemtype="http://schema.org/CollegeOrUniversity" role="banner">
    <div class="row">
      <div class="large-4 medium-4 columns" itemprop="logo">
        <a itemprop="url" href="<?php echo get_home_url(); ?>" class="logo" itemprop="name"><?php bloginfo('name') ?></a>
      </div>
  ...
  <div class="top-bar-container contain-to-grid show-for-medium-up">
    <nav class="top-bar" data-topbar role="navigation" aria-labelledby="MainNavigation">
