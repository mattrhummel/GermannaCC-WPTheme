...
/*
Template Name: Lyceum Community
*/
get_header(); ?>
	...
	<main class="small-12 medium-8 medium-push-4 large-8 columns large-push-4" id="main" role="main">
		...
		<article <?php post_class() ?> id="post-<?php the_ID(); ?>" >
			<div class="entry-content">
				<?php $loop = new WP_Query( array( 'post_type' => 'lyceum_commun_events', 'posts_per_page' => 10, 'orderby' => 'post_id', 'order' => 'ASC',  ) ); ?>
				...
				<div class="panel">
					...
					<div class="row">
						<div class="small-12 medium-7 columns">
							...
							<a href="<?php echo $community_event_url; ?>" class="button button-default" target="_blank" role="button" aria-label="Read more about <?php the_title(); ?>"><?php echo $button_text; ?></a>
							<?php endif; ?>
						</div>
