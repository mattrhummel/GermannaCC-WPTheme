...
<?php get_template_part( 'parts/custom-banners/lyceum-speakers-banner' ); ?>
...
<a href="<?php echo $speaker_url; ?>" class="button button-default"target="_blank"><?php echo $button_text; ?></a>
<?php endif; ?>
