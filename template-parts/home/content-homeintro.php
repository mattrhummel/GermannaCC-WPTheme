...
?>
<main class="home-intro" id="main" role="main">
<div class="row">
<div class="container">
...
<?php endif; ?>
<a href="<?php echo $events_button_url; ?>" class="button default text-center" target="_blank" role="button"><?php echo $events_button_text; ?></a>
</div>
