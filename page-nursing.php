...
<div class="row">
    ...
    <div class="small-12 medium-12 large-12 columns" role="main">
        ...
        <li class="" role="menuitem"><a href="/nursing-health-technologies/">Nursing &amp; Health Technologies</a></li>
        <li class="" role="menuitem"><a href="/nursing/quick-guides/">Quick Guides</a></li>
        <li class="" role="menuitem"><a href="/nursing/academic-prerequisites/">Academic Prerequisites</a></li>
        <li role="menuitem"><a href="/nursing/advising/">Nursing Advising</a></li>
        <li role="menuitem"><a href="http://applications.germanna.edu/nursing-application/application.asp">Application</a></li>
        <li role="menuitem"><a href="/nursing/open-lab/">Open Lab</a></li>
        <li role="menuitem"><a href="/nursing/virtual-hospital/">Virtual Hospital</a></li>
      </ul>
    </div>
</div>
        <?php
...
<div class="row">
  ...
  <div class="row">
    ...
    <!--Get Page Sidebars-->
    <?php get_template_part( 'parts/sidebars/nursing-sidebar' ); ?>
    <!--.sidebars-->
  </div>
  <?php get_footer(); ?>